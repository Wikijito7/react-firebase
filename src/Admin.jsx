...
const Admin = (props) => {
    ...
    const editarTarea = (e) => {
        ...
        try {
            await db.collection(collectionName).doc(tareaEditar.id).set({name: tarea, fecha: tareaEditar.fecha});
            const tareasArray = tareas.map(t => t.id === tareaEditar.id ? (tareaEditada) : t);
    ...
    return (
        <div className="container mt-4">
            <h1 className="text-center mb-5">Bienvenido {user && user.email}</h1>
