...
const Login = (props) => {
    ...
    return (
        <div className="mt-5">
            <h3 className="text-center">{modoRegistro? "Registro": "Login"}</h3>
            <hr/>
            <div className="row justify-content-center">
                <div className="col-12 col-sm-8 col-md-6 col-xl-4">
                    <form onSubmit={(e) => validarDatos(e)}>
                        ...
                        <button className="btn btn-large btn-dark w-100 mb-2">{modoRegistro? "Registro": "Login"}</button>
                        <button type="button" onClick={() => setModoRegistro(!modoRegistro)} className="btn btn-sm btn-info w-100 mb-2">{modoRegistro? "¿Tienes cuenta?": "¿No tienes cuenta?"}</button>
                        {
                        !modoRegistro && (
                            <button 
